...
export const questions = [
  {
    ...
    content: () => (
      <div>
        ...
        <p>
        Let our imagination speak and build something great and unique by mixing all of the Loot related NFTs.
        </p>
      </div>
    )
  },
  {
    question: 'Why Spell & Talent is a nice addition to Loot Project and N Project?',
    content: () => (
      <div>
        <p>
        Even with our traveller's equipment we are not always ready to set off on an adventure. Enemies, creatures and other difficulties can cause us a lot of troubles. Spell & Talent provide us the necessary skills that support us during our adventure. With those skills it will be much easier to overcome problems. 
        </p>
        <p>
  ...
  {
    question: 'How can I get Spell & Talent?',
    content: () => (
      <div>
        <p>
        Spell & Talent can only be claimed once by Loot and N project NFT. It is enough to provide the ID from the loot. The remaining can be minted by anyone.
        </p>
      </div>
    )
  }
